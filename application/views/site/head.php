<meta http-equiv="Content-Type" content="text/html ;charset=utf-8" />
	...
	<link rel="stylesheet" href="https://use.typekit.net/taa1hrr.css">
	<!-- End CSS -->

	<link rel="shortcut icon" type="image/x-icon" href="<?php echo public_url('image/webava')?>/1f427.png" />
	...
	<title>Chim cánh cụt store</title>